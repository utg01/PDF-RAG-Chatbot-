...
st.set_page_config(
    page_title="PDF Chatbot with cache and chunk reranking",
    page_icon="📄"
)
...
if not st.session_state.pdf_uploaded:
    ...
    st.info("The chatbot currently works with text-based PDFs, not scanned/image-only PDFs.")
    ...
    if uploaded_file:
        ...
        st.session_state.current_index = result
    ...
    if humanmsg:
        ...
        st.session_state.display_messages.append(final_response)
